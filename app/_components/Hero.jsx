            ...
            <div className="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:items-center">
                <div className="mx-auto max-w-xl text-center">
                    <h1 className="text-3xl font-extrabold sm:text-5xl">
                        AI Voice Bot and ChatBot
                        <strong className="font-extrabold text-primary sm:block"> Custom Learning Paths, Powered by AI </strong>
                    </h1>
                    <p className="mt-4 sm:text-xl/relaxed">
                        Unlock personalized education with AI-driven Voice Bot and Chatbot. Tailor your learning journey to fit your unique goals and pace.
                    </p>
